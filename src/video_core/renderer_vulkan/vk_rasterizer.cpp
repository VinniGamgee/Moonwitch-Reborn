...
void RasterizerVulkan::Clear(u32 layer_count) {
    ...
    VkClearRect clear_rect{
        .rect = regs.clear_control.use_scissor ? GetScissorState(regs, 0, up_scale, down_shift, exact_scale)
                                               : default_scissor,
...
void RasterizerVulkan::UpdateScissorsState(Tegra::Engines::Maxwell3D::Regs& regs) {
    ...
    const std::array scissor_list{
        GetScissorState(regs, 0, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 1, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 2, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 3, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 4, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 5, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 6, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 7, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 8, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 9, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 10, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 11, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 12, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 13, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 14, up_scale, down_shift, exact_scale),
        GetScissorState(regs, 15, up_scale, down_shift, exact_scale),
    };
